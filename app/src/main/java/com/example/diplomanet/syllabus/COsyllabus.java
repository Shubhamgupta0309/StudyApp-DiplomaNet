...
public class COsyllabus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cosyllabus);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                COsyllabus.super.onBackPressed();
            }
        });
        ...
        FirebaseRecyclerOptions<syllabusmodel> options =
                new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("COSyllabus"), syllabusmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<syllabusmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("COSyllabus").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), syllabusmodel.class)
                                .build();
