...
public class EJsyllabus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejsyllabus);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EJsyllabus.super.onBackPressed();
            }
        });
        ...
        FirebaseRecyclerOptions<syllabusmodel> options =
                new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("EJSyllabus"), syllabusmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<syllabusmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("EJSyllabus").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), syllabusmodel.class)
                                .build();
