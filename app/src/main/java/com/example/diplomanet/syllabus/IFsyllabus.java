...
public class IFsyllabus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ifsyllabus);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IFsyllabus.super.onBackPressed();
            }
        });
        ...
        FirebaseRecyclerOptions<syllabusmodel> options =
                new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("IFSyllabus"), syllabusmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<syllabusmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<syllabusmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("IFSyllabus").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), syllabusmodel.class)
                                .build();
