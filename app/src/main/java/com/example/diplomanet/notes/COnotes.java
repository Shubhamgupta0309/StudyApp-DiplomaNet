...
public class COnotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conotes);
        ...
        FirebaseRecyclerOptions<notesmodel> options =
                new FirebaseRecyclerOptions.Builder<notesmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("CONotes"), notesmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<notesmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<notesmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("CONotes").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), notesmodel.class)
                                .build();
