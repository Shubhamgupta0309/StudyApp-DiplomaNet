...
public class MEnotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menotes);
        ...
        FirebaseRecyclerOptions<notesmodel> options =
                new FirebaseRecyclerOptions.Builder<notesmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("MENotes"), notesmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<notesmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<notesmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("MENotes").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), notesmodel.class)
                                .build();
