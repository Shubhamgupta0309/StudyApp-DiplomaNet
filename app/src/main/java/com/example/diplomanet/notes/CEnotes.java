    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<notesmodel> options =
                new FirebaseRecyclerOptions.Builder<notesmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("CENotes"), notesmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<notesmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<notesmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("CENotes").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), notesmodel.class)
                                .build();
