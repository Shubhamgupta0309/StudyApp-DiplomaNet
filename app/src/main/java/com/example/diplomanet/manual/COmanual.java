...
public class COmanual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comanual);
        ...
        FirebaseRecyclerOptions<manualmodel> options =
                new FirebaseRecyclerOptions.Builder<manualmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("COManual"), manualmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<manualmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<manualmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("COManual").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), manualmodel.class)
                                .build();
