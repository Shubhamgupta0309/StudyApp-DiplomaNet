...
public class CEmanual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cemanual);
        ...
        FirebaseRecyclerOptions<manualmodel> options =
                new FirebaseRecyclerOptions.Builder<manualmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("CEManual"), manualmodel.class)
                        .build();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                FirebaseRecyclerOptions<manualmodel> newOptions =
                        new FirebaseRecyclerOptions.Builder<manualmodel>()
                                .setQuery(FirebaseDatabase.getInstance().getReference().child("CEManual").orderByChild("filename").startAt(newText).endAt(newText + "\uf8ff"), manualmodel.class)
                                .build();
